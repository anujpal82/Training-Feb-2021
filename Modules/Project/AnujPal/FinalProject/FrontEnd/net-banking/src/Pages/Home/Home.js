      ...
      >
        <div classname="container col-md-12">
          <ul class="list-inline ms-4 ">
            <li className="list-inline-item px-4">About Us</li> |
            <li className="list-inline-item px-4">Affiliates</li>|
            <li className="list-inline-item px-4">Corporate Governance</li>|
            <li className="list-inline-item px-4">Investor Relations</li>|
            <li className="list-inline-item px-4">SBI In The News</li>|
            <li className="list-inline-item px-4">Contact Us</li>|
            <li className="list-inline-item px-4">Site Map</li>|
            <li className="list-inline-item px-4">Disclaimer</li>
          </ul>
